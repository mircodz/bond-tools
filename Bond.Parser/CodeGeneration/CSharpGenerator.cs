...
/// <summary>Generates schema models for the existing Bond C# runtime.</summary>
public static class CSharpGenerator
{
    ...
    public static CSharpGenerationResult Generate(Syntax.Bond ast, string filePath)
    {
        ArgumentNullException.ThrowIfNull(ast);
        ArgumentNullException.ThrowIfNull(filePath);
        return new Emitter(ast, filePath).Generate();
    }
    ...
    private sealed class Emitter(Syntax.Bond ast, string filePath)
    {
        ...
        private void EmitStruct(StructDeclaration structure)
        {
            ...
            foreach (var field in structure.Fields.OrderBy(field => field.Ordinal))
            {
                ...
                var initialValue = DefaultValue(field, type);
            ...
            switch (type)
            {
                ...
                case BondType.Nullable nullable:
                {
                    ...
                    return new(element.Name + (element.IsScalar ? "?" : ""),
                        ...
                        IsValueType: !element.IsScalar && element.IsValueType);
                }
                case BondType.Maybe maybe:
                {
                    ...
                    return new(element.Name + suffix, element.SchemaType + schemaSuffix,
                        ...
                        IsSchemaValueType: schemaSuffix.Length == 0 && element.IsSchemaValueType);
                }
        ...
        private string? DefaultValue(Field field, MappedType mapped)
        {
        ...
        private static string[] CSharpNamespace(Declaration declaration)
        {
        ...
        private static string QualifiedName(Declaration declaration) =>
